...
> **Print this!** Tento dokument ti dá 80% hodnoty za 5 minut čtení.
...
| 5 | **Definuj úspěch** | "Analyzuj..." | "Úspěch = min 5 findings, každý s řešením" |
...
A: Neexistuje žádný. Záleží na use case. Pro většinu: Claude Sonnet 4 nebo GPT-4.1.
