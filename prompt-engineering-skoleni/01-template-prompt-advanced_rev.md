...
## 🎯 HLAVNÍ ÚKOL
> **Proč je tato sekce první:** Začni s tím nejdůležitějším - co vlastně chceš.
...
**Situace:**
[Popiš aktuální stav, problém nebo příležitost. 2-4 věty stačí.]
...
- 5+ příkladů: komplexní pattern recognition
