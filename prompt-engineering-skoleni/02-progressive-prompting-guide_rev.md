...
Potřebuju připravit report pro product team aby věděli na co se zaměřit v Q1 2026.
...
2. **Positioning & Messaging (měsíc 2-3):**
   - Adaptuj value proposition pro polský trh
...
**Máš otázky?**
Všechno je o praxi. První prompt nikdy není perfektní. Iteruj, testuj, uč se co funguje pro TVŮJ use case.
